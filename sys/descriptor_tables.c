...
static void init_gdt()
{
	...
	gdt_set_gate(3, 0, 0xFFFFFFFF, 0xFA, 0xCF);	//Iser mode code
...
static void init_idt()
{
    ...
    //Create IDT table. Set up interrupts
...
static void idt_set_gate(uint8 num, uint32 base, uint16 sel, uint8 flags)
{
	...
	//Uncomment the OR if you want user mode.
